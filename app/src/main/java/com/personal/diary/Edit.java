...
public class Edit extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if(item.getItemId() == R.id.save){
            Diary note = new Diary(nId,nTitle.getText().toString(),nContent.getText().toString(),todaysDate,currentTime);
            ...
            goToMain();
            Toast.makeText(this, "Diary Edited.", Toast.LENGTH_SHORT).show();
